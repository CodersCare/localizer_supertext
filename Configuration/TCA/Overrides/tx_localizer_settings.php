...
$GLOBALS['TCA']['tx_localizer_settings']['types']['localizer_supertext']['showitem'] = 'hidden, --palette--;;1, type, title, description, url, projectkey, username, password, --palette--;;2, --palette--;;3, l10n_cfg, source_locale, target_locale';
